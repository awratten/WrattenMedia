		...
		<div class="container text-center">
			<div class="call-to-action">
				...
				<div class="col-lg-2 col-lg-offset-3 text-center">
					<a href="https://www.facebook.com/WrattenMedia/" target="_BLANK" style="color:white;"><i class="fa fa-facebook-official fa-3x sr-contact"></i></a>
				</div>
				<div class="col-lg-2 text-center">
					<a href="https://www.instagram.com/wrattenmedia/" target="_BLANK" style="color:white;"><i class="fa fa-instagram fa-3x sr-contact"></i></a>
				</div>
				<div class="col-lg-2 text-center">
					<a href="https://www.pinterest.com/Kelwratten" target="_BLANK" style="color:white;"><i class="fa fa-pinterest-square fa-3x sr-contact"></i></a>
				</div>
			</div>
		</div>
	</aside>
